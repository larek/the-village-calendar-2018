              ...
              return(
                  <div className="col-4">
                      <div id='cf2' onClick={this.change.bind(this)} data-display={item.day > this.state.currentDay ? 'lock' : 'visible'} data-status={window.localStorage && localStorage[item.day] ? 'open' : 'close'} data-day={item.day}>
                        ...
                        <img id="back" onClick={this.redirect.bind(this, item.link)} src={item.day > 25 ? 'http://placehold.it/200x200' : "http://reports.larek.pro/api/the-village-calendar-2018/images/day-" + item.day + "-back.svg"} className={window.localStorage && localStorage[item.day] ? '' : 'transparent'} />
                        {
